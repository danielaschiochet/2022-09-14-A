...
public class ItunesDAO {
	...
	public List<Pair<Integer, Integer>> getArchi(){
		final String sql = "SELECT DISTINCT a1.AlbumId, a2.AlbumId "
				...
				+ "AND pt1.TrackId=t1.TrackId AND pt2.TrackId=t2.TrackId "
		...
		try {
			...
			while (res.next()) {
				result.add(new Pair<Integer, Integer>(res.getInt("a1.AlbumId"), res.getInt("a2.AlbumId")));
			}
			conn.close();
		} catch (SQLException e) {
			e.printStackTrace();
